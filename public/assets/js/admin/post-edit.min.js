...
$(document).ready(function () {
    ...
    $('#save').click(function (event) {
        ...
        if (save) {
            ...
            var url = baseUrl + "api/admin/ajax/post-save";

            var message = "Gravado com sucesso!";
    ...
    $('#image').change(function () {
        if ($('#image').prop('files').length) {
            var url = baseUrl + "api/admin/ajax/post-view-image";
            var data = new FormData();
            data.append('image', $('#image').prop('files')[0]);
    ...
    $('#del-image').click(function () {
        ...
        $('#bnt-del-image').click(function () {
            ...
            var url = baseUrl + "api/admin/ajax/post-destroy-image";
            var message = "Imagem apagada!";
    ...
    $('#del').click(function () {
        ...
        var msg = "Confirma, exclusão da matéria <strong>" + $('#id').val() + "</strong>?";
    ...
    $('#files').change(function () {
        if ($('#id').val() == '') {
            ...
            var url = baseUrl + "api/admin/ajax/post-upload";
            var data = new FormData();
            var files = [];
            ...
            axios.post(url, data).then(function (response) {
                ...
                for (var _i = 0; _i < files.length; _i++) {
                    ...
                    if (files[_i]['icon'] == false) {
                        html += '<img src="' + files[_i]['url'] + '" width="100" alt="">';
                    } else {
                        html += '<i class="fa fa-fw ' + files[_i]['icon'] + '"> </i>';
                    }
                    html += '<p>' + files[_i]['name'] + '</p>';
                    html += '<input type="hidden" id="url" value="' + files[_i]['url'] + '">';
    ...
    function actionsBind() {
        ...
        $(".upload-del").bind("click", function () {
            ...
            var filename = item.find('p').eq(0).html();
            ...
            $('#bnt-del-image').click(function () {
                ...
                var url = baseUrl + "api/admin/ajax/post-upload-del";
                var message = "Arquivo apagado!";
