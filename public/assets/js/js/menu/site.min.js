    ...
    121: function(n, e) {
        var t = {
            ...
            menuMobile: {
                ...
                close: function() {
                    $("nav.menu").on("click", "a.closeMenu", function() {
                        $("nav.menu").removeClass("active"),
                            $("body").removeClass("mMOpen"),
                            $("nav.menu ul.links li").find(".subnav-container, .dropnav-container").removeClass("active"),
                            $("nav.menu .busca").find(".buscaContainer").removeClass("active")
                    })
                },
                submenu: function() {
                    $("nav.menu > ul.links > li").on("click", "> a", function() {
                        $(this).parent().find(".subnav-container, .dropnav-container").hasClass("active") ? ($(this).parent().find(".subnav-container, .dropnav-container").removeClass("active"), $(this).removeClass("active")) : ($("nav.menu ul.links li").find(".subnav-container, .dropnav-container").removeClass("active").parent().find("> a").removeClass("active"), $(this).parent().find(".subnav-container, .dropnav-container").addClass("active"), $(this).addClass("active"))
                    })
                },
                indices: function() {
                    var n = $(this).parent();
            ...
            menu: function() {
                ...
                $("body > header > .menu-line > div > nav.menu > .links > li").on("click", "> a", function(n) {
                    ...
                    $("body > header > .menu-line > div > nav.menu > .buttons > .indices").on("click", "> a", function(n) {
                        var e = $(n.currentTarget).parent(),
                            t = e.parent().parent().find(".links > li");
