...
<div class="container">
    ...
    <div class="container internal">
        <div class="col-12 col-sm-7 col-md-8 no-padding-left no-padding-xs">
            <h1 class="interal-title" style="padding-top: 0px;padding-bottom: 0px !important;">{{$DadosHead->title}}</h1>
            <!-- Versão Mobil -->
            <!-- Go to www.addthis.com/dashboard to customize your tools -->
            <div class="addthis_inline_share_toolbox_9yn6 LabelMobil1" style="margin-top: -15px;"></div>
            <br>
            <h1 class="title-internal2 LabelMobil1" style="padding-top: 0px;padding-bottom: 0px !important;">{{$post->title}}</h1>
            <!-- FIM -->
